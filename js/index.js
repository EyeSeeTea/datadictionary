var _queryURL_getOrgUnit = "../../dhis/api/organisationUnits";
...
function DataManager() {
	...
	me.queryURL_DataElementGet = "../../dhis/api/dataElements/";
	me.queryURL_IndicatorGet = "../../dhis/api/indicators/";
	me.queryURL_DataElementListGet = "../../dhis/api/dataElements.json?paging=false";
	me.queryURL_DataSetListGet = "../../dhis/api/dataSets.json?paging=false";
	me.queryURL_DataSetDetailGet = "../../dhis/api/dataSets/";

	me.queryURL_getCountries = "../../dhis/api/organisationUnits.json?level=3";
	...
	me.setup_SearchByCountry = function(afterFunc) {
		...
		me
				.populateCountryList(me.countryListTag, 'countriesLoading',
						afterFunc);
